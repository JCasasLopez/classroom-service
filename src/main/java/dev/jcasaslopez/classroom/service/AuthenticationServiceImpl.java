...
public class AuthenticationServiceImpl implements AuthenticationService {
	...
	public AuthenticationServiceImpl(@Value("${jwt.secretKey}") String base64SecretKey) {		
	...
	private void purposeIsValid(String purpose) {
		if(!TokenType.ACCESS.prefix().equals(purpose)) {
			throw new FailedAuthenticatedException("Token is not a access token");
		}
	}
